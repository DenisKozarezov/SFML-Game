...
{
	const std::string Sprites = std::string("C:/Users/Acer/source/repos/Game/resources/sprites/");
	const std::string Audio = std::string("C:/Users/Acer/source/repos/Game/resources/audio/");
}
